...
public class StringManipulation01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("t.indexOf(\"java\") = " + t.indexOf("java")); //0     first way
        int idxJava=t.indexOf("java");
        System.out.println("idxJava = " + idxJava);  //0     second way
        ...
        System.out.println("idxM = " + idxM); //3
