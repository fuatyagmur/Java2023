...
public class Loops01 {
    ...
    public static void main(String[] args) {
        ...
        for (int i=11 ; i<45 ; i=i+1){
            System.out.print((i%2==0 ? i : i++) +" "); // writes odd numbers
        }
        ...
        */
        ...
        for (int i=68; i>12; i--){
            if ((i%2)==1){
                System.out.print(i+" ");   // if(i%2 != 0) we would use this way also
            }
        }
        ...
        for (char i='c' ; i<'v' ; i++){   // of i+=1; could we use    but not this way ==> i=i+1
            System.out.print(i + " ");
        ...
        for (int i='a'-'a' ; i<'e' ; i++){
            System.out.print(i+ " ");     // 'e'=101   'a'-'a'=0 start point
        }
        ...
        int dh='m';
        System.out.println("dh = " + dh); //109(ASCII value of m)
