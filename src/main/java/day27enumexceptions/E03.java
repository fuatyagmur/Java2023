...
public class E03 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(convertStringToInt("123a"));//NumberFormatException ==> For input string: "123a"
        //If you try to convert a String that contains a non-digit character to a number
