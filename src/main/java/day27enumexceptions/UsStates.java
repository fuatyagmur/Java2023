...
public enum UsStates {
    /*
    Enum is a storage to store constant data your application needs.
    For ex: For "Car Sale" application you need "Car Makes" that is why you have to store "Car Makes" int your application.
