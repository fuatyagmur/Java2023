...
public class lists12_mountainArray {
    public static void main(String[] args) {
        ...
        //Not Mountain Array ==> [5, 2, 7, 1, 4] It is decreasing then increasing to the maximum value, decreasing and increasing after the maximum value
